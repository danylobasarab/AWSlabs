...
public class Establishment {
    ...
    @ManyToMany
    @JoinTable(name = "establishment_review_of_establishment", catalog = "", schema = "pavlo_turchynyak", joinColumns = @JoinColumn(name = "establishment_id", referencedColumnName = "id", nullable = false), inverseJoinColumns = @JoinColumn(name = "review_of_establishment_id", referencedColumnName = "id", nullable = false))
